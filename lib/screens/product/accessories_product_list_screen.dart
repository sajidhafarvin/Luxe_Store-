...
class AccessoriesProductListScreen extends StatefulWidget {
  const AccessoriesProductListScreen({Key? key}) : super(key: key);
...
class _AccessoriesProductListScreenState extends State<AccessoriesProductListScreen> {
  ...
  final List<String> filters = ["All", "Jewelry", "Bags", "Belts", "Watches"];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("ACCESSORIES", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 16, color: theme.colorScheme.primary)),
        ...
        children: [
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text("CURATED FOR YOU", style: GoogleFonts.poppins(fontSize: 11, color: Colors.white60, letterSpacing: 2)),
              const SizedBox(height: 8),
              Text("THE ESSENTIALS", style: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.white)),
              const SizedBox(height: 8),
              Text("Complete your look with our curated collection.", style: GoogleFonts.poppins(fontSize: 13, color: Colors.grey[300])),
            ]),
          ),
          Expanded(
            child: StreamBuilder<List<Product>>(
              stream: _productRepository.watchProducts(category: 'Accessories'),
